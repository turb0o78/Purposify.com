          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            <div className="md:w-1/2 relative">
              ...
              <div className="relative rounded-3xl overflow-hidden border-8 border-white shadow-2xl">
                <img 
                  src="/lovable-uploads/e7b8f765-25aa-4993-adcb-c04df1669eae.png" 
                  alt="Phone showing notifications from multiple platforms" 
      ...
      <footer className="py-12 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 pt-8">
            <p className="text-gray-400 text-sm">© {new Date().getFullYear()} Purposify. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
